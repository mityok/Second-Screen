package com.cellcom.soccer{
	...
	public class FullScreenView extends Sprite {
		...
		public function FullScreenView() {
			...
			back.graphics.drawRect(0,0,GlobalConst.MAIN_WIDTH,GlobalConst.MAIN_HEIGHT);
			back.graphics.endFill();
			//
			imageFrame.graphics.beginFill(SoccerUiConst.BG_GREEN,1);
			imageFrame.graphics.drawRect(0,-FRAME_OFFSET,SoccerUiConst.FULL_SCREEN_MAX_WIDTH,FRAME_OFFSET+SoccerUiConst.FULL_SCREEN_MAX_HEIGHT);
			imageFrame.graphics.endFill();
			//
			imageFrame.x=(-SoccerUiConst.FULL_SCREEN_MAX_WIDTH)/2;
			imageFrame.y = (-SoccerUiConst.FULL_SCREEN_MAX_HEIGHT/2)+100;
			...
			imageBorder.graphics.drawRect(0,0,SoccerUiConst.FULL_SCREEN_MAX_WIDTH,SoccerUiConst.FULL_SCREEN_MAX_HEIGHT+FRAME_OFFSET);
			...
			imageContainer.x = GlobalConst.MAIN_WIDTH / 2;
			imageContainer.y = GlobalConst.MAIN_HEIGHT / 2;
			this.visible = false;
		...
		private function onLoadDone(e:Event) {
			loader.width = SoccerUiConst.FULL_SCREEN_MAX_WIDTH;
			loader.height = SoccerUiConst.FULL_SCREEN_MAX_HEIGHT;
			...
			loader.x=(-loader.width + SoccerUiConst.FULL_SCREEN_MAX_WIDTH)/2;
			loader.y=(-loader.height + SoccerUiConst.FULL_SCREEN_MAX_HEIGHT)/2;
			this.loaded = true;
			showAfterLoad();
